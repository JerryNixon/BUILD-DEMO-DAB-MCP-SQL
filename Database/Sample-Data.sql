...
VALUES 
(1539726, 'Jack', 'Lee', '123 Old Road', 'Bellevue', 'WA', '98007', 'USA', 'jlee@contoso.com', '{"active-policies": ["car", "renters"]}'),
(920411, 'John', 'Doe', '456 Main St', 'Redmond', 'WA', '98052', 'USA', 'jd@adventureworks.com', '{"active-policies": ["umbrella", "car", "homeowners"]}'),
(290332, 'Alice', 'Smith', '789 Lake Road', 'Kirkland', 'WA', '98017', 'USA', 'asmith@contoso.com', '{"active-policies": ["car", "boat"]}')
...
(12012, 920411, 'phone', '2023-09-20', 'customer reached out to understand if his policy also covers rented cars. Customer was informed that the policy does cover rented cars for up to 15 days. Car must be rented in the US and Canada. Customer was very happy with the information.'),
...
(18928, 920411, 'mail', '2024-07-17', 'customer very unhappy about the premium is increased again. almost furious as he didn''t get any upfront information about that. evaluating to move to another company.'),
